...
def process_ffmpeg(raw_vid_path, save_folder, save_vid_name, bbox, time):
    ...
    def to_square(bbox):
        ...
        left_x, right = c_w - c, c_w + c
        return top, bottom, left_x, right

    def de_norm(bbox, height, width):
    ...
    top, bottom, left, right = to_square(de_norm(expand(bbox, 0.02), height, width))
